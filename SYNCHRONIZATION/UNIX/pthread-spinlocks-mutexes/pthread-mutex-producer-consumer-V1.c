...
pthread_mutex_t available_data[SIZE]; // un mutex per ogni locazione, per indicare se c'è qualcosa da leggere
pthread_mutex_t available_slot[SIZE]; // un mutex per ogni locazione, per indicare se lo spazio è libero per la scrittura
