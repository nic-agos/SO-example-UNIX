...
int main (int argc, char *argv[]){
   ...
   /*se attivo questo programma con -p l'analisi viene fatta periodicamente*/
   ...
   do {
      ...
      /*stampo le nuove informazioni solo se cambiate*/
   ...
   } while(continous); //non esco mai dal ciclo se continuos = 1 finchè non esco da shell
